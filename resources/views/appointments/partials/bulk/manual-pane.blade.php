<div id="pane-manual">
    <div class="card border-secondary p-0 shadow-lg overflow-hidden bg-card">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" style="table-layout: fixed; width: 1180px;">
                {{-- FIXED: Expanded width and min-width properties to headers to prevent button text clipping --}}
                <thead class="bg-black text-secondary uppercase small" style="font-size: 0.75rem; letter-spacing: 0.5px;">
                    <tr>
                        ...
                        <th class="pe-4 text-center" style="width: 160px; min-width: 160px;">Action</th>
                    </tr>
                </thead>
