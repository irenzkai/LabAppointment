...
<div class="container-fluid text-start animate-page">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3" style="border-color: var(--border-color) !important;">
        <div>
            <h2 class="text-accent fw-bold mb-0 uppercase tracking-tighter">Staff Dashboard</h2>
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <a href="{{ route('services.manage') }}" class="card p-3 border-secondary bg-card text-decoration-none hover-card shadow-sm h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="p-2.5 rounded bg-secondary bg-opacity-10 text-accent fs-4"><i class="bi bi-list-stars"></i></div>
                    <div>
        ...
        <div class="col-6 col-md-3">
            <a href="{{ route('appointments.index', ['view' => 'queue']) }}" class="card p-3 border-secondary bg-card text-decoration-none hover-card shadow-sm h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="p-2.5 rounded bg-secondary bg-opacity-10 text-accent fs-4"><i class="bi bi-kanban"></i></div>
                    <div>
        ...
        <div class="col-6 col-md-3">
            <a href="{{ route('admin.payment-providers.index') }}" class="card p-3 border-secondary bg-card text-decoration-none hover-card shadow-sm h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="p-2.5 rounded bg-secondary bg-opacity-10 text-accent fs-4"><i class="bi bi-qr-code-scan"></i></div>
                    <div>
        ...
        <div class="col-6 col-md-3">
            <a href="{{ route('admin.appointment-settings') }}" class="card p-3 border-secondary bg-card text-decoration-none hover-card shadow-sm h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="p-2.5 rounded bg-secondary bg-opacity-10 text-accent fs-4"><i class="bi bi-clock-history"></i></div>
                    <div>
                        <div class="fw-bold text-main small uppercase"><i class="bi bi-clock me-1"></i>Schedule Editor</div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-6">
            <div class="card p-4 border-secondary bg-card shadow-sm h-100 text-start">
                <h6 class="text-accent fw-bold uppercase small mb-3"><i class="bi bi-graph-up-arrow me-1.5"></i>Monthly Appointment Booking Trends</h6>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2. Status Doughnut Chart (Includes Expired)
