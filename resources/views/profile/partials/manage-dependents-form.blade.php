        ...
        <div class="col-md-6 text-start">
            <div class="p-3 rounded border border-secondary border-opacity-20 d-flex justify-content-between align-items-center h-100" style="background-color: var(--bg-card); color: var(--text-main);">
                ...
                <div class="d-flex gap-1.5">
                    ...
                    {{-- Independent Account Promotion Button --}}
...
@foreach($user->dependents as $dep)
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form action="{{ route('dependents.update', $dep->id) }}" method="POST" id="editDependentForm{{ $dep->id }}" class="modal-content shadow-lg edit-dep-form" data-dep-id="{{ $dep->id }}" onsubmit="compileEditDepAddress('{{ $dep->id }}')" style="background-color: var(--bg-card); border: 1.5px solid var(--border-color); color: var(--text-main);">
                ...
                <div class="modal-body p-4 text-start">
                    ...
                    <div class="mb-3 border-top border-secondary border-opacity-25 pt-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label text-neon fw-bold" style="font-size: 0.65rem;" for="editUseMyAddress{{ $dep->id }}">INHERIT MY ADDRESS</label>
                            </div>
                        </div>
                    </div>

                    {{-- 1. Registered Address on File --}}
                    ...
                    {{-- 2. Inherited Parent Address Preview Box --}}
    ...
    <div class="modal fade" id="promoteModal{{ $dep->id }}" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
        {{-- FIXED: Added dynamic, encrypted promoUrl calculation block to resolve Undefined Variable exception --}}
        @php
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-accent btn-sm" onclick="navigator.clipboard.writeText('{{ $promoUrl }}'); alert('Link copied to clipboard!')">Copy</button>
                        </div>
                    </div>
