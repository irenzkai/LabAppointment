...
<div class="container text-start animate-page">
    ...
    <div class="d-flex justify-content-between align-items-center mb-5 border-bottom border-secondary border-opacity-25 pb-4">
        <div>
            <h2 class="text-accent fw-800 mb-1 uppercase tracking-tight">
                <i class="bi bi-list-stars me-2"></i>Manage Laboratory Services
            </h2>
    ...
    {{-- Modals Inclusion --}}
    @include('services.partials.add-modal')
